...
-- Dumping structure for table ecommerce.carousels
CREATE TABLE IF NOT EXISTS `carousels` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `small_header` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `h2_header` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `chats` (
  ...
  `sent_by_user` tinyint(1) DEFAULT '0',
  `sent_by_customer` tinyint(1) NOT NULL DEFAULT '0',
  `receive_by_user` tinyint(1) DEFAULT '0',
  `receive_by_customer` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `payment_timestamp` text COLLATE utf8mb4_unicode_ci,
  `delivery_address` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `delivery_date` text COLLATE utf8mb4_unicode_ci,
  `delivery_timestamp` text COLLATE utf8mb4_unicode_ci,
...
-- Dumping structure for table ecommerce.order_cancels
CREATE TABLE IF NOT EXISTS `order_cancels` (
  ...
  `order_date` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `cancel_date` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping structure for table ecommerce.other_images
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `stock_amount` int NOT NULL DEFAULT '1',
  ...
  `exchangeable_with` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
-- Dumping structure for table ecommerce.units
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `image` text COLLATE utf8mb4_unicode_ci,
  `role` tinyint NOT NULL COMMENT '0=admin,1=users',
  PRIMARY KEY (`id`),
