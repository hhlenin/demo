                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <img class="rounded-circle header-profile-user" src="{{asset('/')}}admin/assets/images/users/avatar-1.jpg"
                             alt="Header Avatar">
                        <span class="d-none d-xl-inline-block ml-1">{{Session::get('customer_name')}}</span>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('carousel.index')}}">Manage Carousel</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('customer.product.add')}}">Add Product</a></li>
                            <li><a href="{{route('customer.product.manage')}}">Manage Product</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('customer.chats.index')}}">Messages</a></li>
                        </ul>
                    </li>
