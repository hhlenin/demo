                ...
                <div class="col-lg-8 col-12 custom-padding-right">
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider" style="background-image: url({{asset($c->image)}});">
                                <div class="content">
                                    <h2><span>{{ $c->small_header }}</span>
                                        {{ $c->h2_header }}
                                    </h2>
                                    <p>{{ $c->paragraph }}</p>
                                    <h3><span>Now Only</span> ${{ $c->price }}</h3>
                                    <div class="button">
                                        <a href="{{ $c->link?? '#' }}" class="btn">Shop Now</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p>High Demand Categories, recommanded by us</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <ul>
                            @foreach (DB::table('sub_categories')->where('category_id', $category->id)->get() as $item)
                                <li><a href="product-grids.html">{{ $item->name }}</a></li>
                            @endforeach
                        </ul>
                        <div class="images">
                            <img src="{{asset($category->image)}}"  style="height: 204px; width: 201px; object-fit:cover" alt="#">
                        </div>
                    </div>
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            @if ($product->selling_price == null)
                                <span class=" sale-tag">Exchange</span> 
                            @endif
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Special Offer</h2>
                        <p>Latest Products for Sell & Exchange</p>
                    </div>
                </div>
            </div>
            <div class="row">
