                                            ...
                                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="page-title-right">
                                                    <ol class="breadcrumb m-0">
                                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Skote</a>
                                                        </li>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="chat-leftsidebar-nav">
                                                    <ul class="nav nav-pills nav-justified">
                                                        <li class="nav-item">
                                                            <a href="#chat" data-toggle="tab" aria-expanded="true"
                                                                            ...
                                                                            <div class="media">
                                                                                ...
                                                                                <div class="media-body overflow-hidden">
                                                                                    <h5
                                                                                        ...
                                                                                        Keith
                                                                                        Gonzales</h5>
                                                                                    <p class="text-truncate mb-0">This
                                                                                        theme is
                                                                                        awesome!</p>
                                                                                </div>
                                                                            ...
                                                                            <div class="media">
                                                                                ...
                                                                                <div class="media-body overflow-hidden">
                                                                                    <h5
                                                                                        ...
                                                                                        Jose
                                                                                        Vickery</h5>
                                                                                    <p class="text-truncate mb-0">Nice to
                                                                                        meet you</p>
                                                                                </div>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="media align-items-center">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <h5 class="font-size-14 mb-0">Reporting
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="media align-items-center">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <h5 class="font-size-14 mb-0">Project A
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="media align-items-center">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <h5 class="font-size-14 mb-0">Project B
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                            ...
                                                            <div data-simplebar style="max-height: 410px;">
                                                                <div>
                                                                    ...
                                                                    <ul class="list-unstyled chat-list">
                                                                        <li>
                                                                            <a href="#">
                                                                                <h5 class="font-size-14 mb-0">Adam Miller
                                                                                </h5>
                                                                            </a>
                                                                        </li>
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <ul class="list-unstyled chat-list">
                                                                        <li>
                                                                            <a href="#">
                                                                                <h5 class="font-size-14 mb-0">Bonnie Harney
                                                                                </h5>
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <ul class="list-unstyled chat-list">
                                                                        <li>
                                                                            <a href="#">
                                                                                <h5 class="font-size-14 mb-0">Charles Brown
                                                                                </h5>
                                                                            </a>
                                                                            <a href="#">
                                                            ...
                                                            <li>
                                                                <div class="conversation-list">
                                                                    ...
                                                                    <div class="ctext-wrap">
                                                                        <div class="conversation-name">Steven Franklin
                                                                        </div>
                                                                        <p>
                                                                            Hello!
                                                                        </p>
                                                            ...
                                                            <div class="col-auto">
                                                                <button type="submit"
                                                                    class="btn btn-primary btn-rounded chat-send w-md waves-effect waves-light"><span
                                                                        class="d-none d-sm-inline-block mr-2">Send</span>
